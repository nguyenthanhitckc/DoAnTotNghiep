...
export default class ChinhSuaChuyenKhoan extends React.Component {
  ...
  componentDidMount() {
    ...
    this.setState({
      maChuyenKhoan: params.ma_chuyen_khoan,
      maTaiKhoanNguon: params.ma_tai_khoan_nguon,
      maTaiKhoanDich: params.ma_tai_khoan_dich,
